            ...
            <div class="control-panel">
                ...
                <div class="panel-section">
                    ...
                    <div class="equation-box">
                        <b><i>u(&lambda;, T) = </i></b> 
                        <span style="font-size: 18px;">&frac21; &pi; h c<sup>2</sup> / [ &lambda;<sup>5</sup> (e<sup>hc / &lambda;k<sub>B</sub>T</sup> - 1) ]</span>
                    </div>
                    <div class="constants-list">
                        <b>h</b> = 6,626 &times; 10<sup>-34</sup> J&middot;s<br>
                        <b>c</b> = 2,998 &times; 10<sup>8</sup> m/s<br>
                        <b>k<sub>B</sub></b> = 1,380 &times; 10<sup>-23</sup> J/K
                    </div>
                </div>
                ...
                <div class="panel-section">
                    ...
                    <div style="font-size: 13px; line-height: 1.6;">
                        • Pico de emissão (&lambda;<sub>max</sub>): <b><span id="resPeak">-</span></b><br>
...
def get_plot():
    ...
    fig.add_annotation(
        ...
        text=f"Pico de emissão (&lambda;<sub>max</sub> = {lambda_max_nm:.1f} nm)",
    ...
    fig.update_layout(
        title=dict(text="<b>Gráfico de Radiança Espectral (u<sub>&lambda;</sub>) vs. Comprimento de Onda (&lambda;)</b>", font=dict(size=16)),
        xaxis=dict(title="<b>Comprimento de Onda &lambda; (nm)</b>", range=[0, max_wave], gridcolor="#e5e5e5"),
        yaxis=dict(title="<b>Radiança Espectral u<sub>&lambda;</sub> (kW / (sr&middot;m&sup2;&middot;nm))</b>", range=[0, max_u * 1.15], gridcolor="#e5e5e5"),
